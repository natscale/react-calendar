...
function checkIfDateIsDisabledHOF(params) {
  var disablePast = params.disablePast,
    disableToday = params.disableToday,
    disableFuture = params.disableFuture,
    customDisabledCheck = params.customDisabledCheck,
    maxDate = params.maxDate,
    minDate = params.minDate,
    applyMax = params.applyMax,
    applyMin = params.applyMin;
  var today = new Date();
...
function getDaysOfMonthViewMetrix(params) {
  var isRangeSelectModeOn = params.isRangeSelectModeOn,
    isRangeView = params.isRangeView,
    selectedDate = params.selectedDate,
    selectedRangeStart = params.selectedRangeStart,
    selectedRangeEnd = params.selectedRangeEnd,
    highlightsMap = params.highlightsMap,
    newSelectedRangeStart = params.newSelectedRangeStart,
    newSelectedRangeEnd = params.newSelectedRangeEnd,
    isSelectMultiDate = params.isSelectMultiDate,
    selectedMultiDates = params.selectedMultiDates,
    yearInView = params.yearInView,
    monthInView = params.monthInView,
    startOfTheWeek = params.startOfTheWeek,
    isDisabled = params.isDisabled,
    checkIfWeekend = params.checkIfWeekend;
  var matrix = [[], [], [], [], [], []];
  var currentMonthDatesStartIndex = getInfluencedWeekDayIndexOnFirstDateOfMonth(
    yearInView,
    monthInView,
    startOfTheWeek,
  );
  ...
  var totalDaysInPrevMonth = getNumberOfDaysInAMonth(
...
function getCellValue(_a) {
  var currDate = _a.currDate,
    activeMonthInView = _a.activeMonthInView,
    highlightsMap = _a.highlightsMap,
    newSelectedRangeEnd = _a.newSelectedRangeEnd,
    newSelectedRangeStart = _a.newSelectedRangeStart,
    selectedDate = _a.selectedDate,
    selectedRangeEnd = _a.selectedRangeEnd,
    selectedRangeStart = _a.selectedRangeStart,
    isDisabled = _a.isDisabled,
    isRangeSelectModeOn = _a.isRangeSelectModeOn,
    isRangeView = _a.isRangeView,
    isSelectMultiDate = _a.isSelectMultiDate,
    row = _a.row,
    weekColumn = _a.weekColumn,
    checkIfWeekend = _a.checkIfWeekend,
    today = _a.today,
    selectedMultiDates = _a.selectedMultiDates,
...
function HeaderComponent(_a) {
  var onClickPrev = _a.onClickPrev,
    onChangeViewType = _a.onChangeViewType,
    onClickNext = _a.onClickNext,
    viewType = _a.viewType,
    viewingMonth = _a.viewingMonth,
    viewingYear = _a.viewingYear,
    yearMatrixEnd = _a.yearMatrixEnd,
    yearMatrixStart = _a.yearMatrixStart,
    layoutCalcs = _a.layoutCalcs;
  return React.createElement(
    'header',
    { style: layoutCalcs.root.arc_header, className: 'arc_header' },
    React.createElement(
      'button',
      {
    ...
    viewType === 'month_dates'
      ? React.createElement(
          ...
          React.createElement('div', null, React.createElement('span', null, viewingYear)),
        )
      : viewType === 'months'
      ? React.createElement(
          'button',
          { style: layoutCalcs.header.arch_header_label, className: 'arc_header_label arc_header_label-months' },
          React.createElement(
            'div',
            {
              onClick: function () {
            ...
            React.createElement('span', null, viewingYear),
          ),
        )
      : React.createElement(
          'button',
          {
            ...
            onClick: function () {
              return onChangeViewType('month_dates');
            },
          },
          React.createElement('div', null, React.createElement('span', null, yearMatrixStart, '-', yearMatrixEnd)),
        ),
    React.createElement(
      'button',
      {
...
function MonthSelectorComponent(_a) {
  var onChangeViewingMonth = _a.onChangeViewingMonth,
    onChangeViewType = _a.onChangeViewType,
    layoutCalcs = _a.layoutCalcs;
  ...
  return React.createElement(
    'div',
    { style: layoutCalcs.root['arc_view-months'], className: 'arc_view-months' },
    monthsViewMatrix.map(function (row, index) {
      return React.createElement(
        'div',
        { style: layoutCalcs.months.arc_view_row, className: 'arc_view_row', key: index },
...
function YearSelectorComponent(_a) {
  var onChangeViewType = _a.onChangeViewType,
    onChangeViewingYear = _a.onChangeViewingYear,
    yearMatrixStart = _a.yearMatrixStart,
    layoutCalcs = _a.layoutCalcs;
  // TODO add highlight slected dates years
  var yearsMatrix = useMemo(
    function () {
  ...
  return React.createElement(
    'div',
    { style: layoutCalcs.root['arc_view-years'], className: 'arc_view-years' },
    yearsMatrix.map(function (row, index) {
      return React.createElement(
        'div',
        { style: layoutCalcs.years.arc_view_row, className: 'arc_view_row', key: index },
        row.map(function (cell) {
          return React.createElement(
            'div',
            {
...
function WeekDaysRowComponent(_a) {
  var weekStartIndex = _a.weekStartIndex,
    weekendIndices = _a.weekendIndices,
    layoutCalcs = _a.layoutCalcs;
  ...
  var _b = useMemo(
    ...
    weekDayOrder = _b.order,
    weekDayMap = _b.map;
  var weekendIndicesMap = useMemo(
    function () {
  ...
  return React.createElement(
    'ul',
    { style: layoutCalcs.weekdaysRow.arc_view_weekdays, className: 'arc_view_weekdays' },
    weekDayOrder.map(function (weekDay, weekdayIndex) {
      return React.createElement(
        'li',
        {
          style: layoutCalcs.weekdaysRow.arc_view_weekdays_cell,
          key: weekDay,
          className: 'arc_view_weekdays_cell' + (weekendIndicesMap[weekdayIndex] ? ' arc_wknd' : ''),
        },
        React.createElement(
          'div',
          { style: layoutCalcs.weekdaysRow.arc_view_weekdays_cell_value },
...
function DayOfMonthSelectorComponent(_a) {
  var selectedDate = _a.selectedDate,
    ...
    selectedRangeEnd = _a.selectedRangeEnd,
    newSelectedRangeStart = _a.newSelectedRangeStart,
    weekStartIndex = _a.weekStartIndex,
    onChangeViewingYear = _a.onChangeViewingYear,
    onChangeViewingMonth = _a.onChangeViewingMonth,
    newSelectedRangeEnd = _a.newSelectedRangeEnd,
    isRangeSelectorView = _a.isRangeSelectorView,
    skipDisabledDatesInRange = _a.skipDisabledDatesInRange,
    setIsRangeSelectModeOn = _a.setIsRangeSelectModeOn,
    fixedRangeLength = _a.fixedRangeLength,
    isFixedRangeView = _a.isFixedRangeView,
    isRangeSelectModeOn = _a.isRangeSelectModeOn,
    isDisabled = _a.isDisabled,
    onChangenSelectedMultiDates = _a.onChangenSelectedMultiDates,
    selectedMultiDates = _a.selectedMultiDates,
    isMultiSelectorView = _a.isMultiSelectorView,
    today = _a.today,
    viewingMonth = _a.viewingMonth,
    onChangenNewSelectedRangeEnd = _a.onChangenNewSelectedRangeEnd,
    onChangenNewSelectedRangeStart = _a.onChangenNewSelectedRangeStart,
    onChangenSelectedRangeEnd = _a.onChangenSelectedRangeEnd,
    onChangenSelectedRangeStart = _a.onChangenSelectedRangeStart,
    onChangenSelectedDate = _a.onChangenSelectedDate,
    layoutCalcs = _a.layoutCalcs,
    weekendIndices = _a.weekendIndices,
    onChange = _a.onChange,
    viewingYear = _a.viewingYear,
    allowFewerDatesThanRange = _a.allowFewerDatesThanRange,
    disableFuture = _a.disableFuture,
    disablePast = _a.disablePast,
    lockView = _a.lockView,
    checkIfWeekend = _a.checkIfWeekend,
    highlights = _a.highlights,
    disableToday = _a.disableToday;
  ...
  var daysOfMMonthViewMatrix = useMemo(
    function () {
  ...
  var onDateClicked = useCallback(
    function (cell) {
      ...
      if (isRangeSelectorView && !isFixedRangeView) {
        ...
        onChange &&
          onChange(
            Object.keys(newselectedMultiDates_1)
              .filter(function (dk) {
                return !!newselectedMultiDates_1[dk];
              })
              .map(function (dk) {
                return newselectedMultiDates_1[dk];
              }),
  ...
  return React.createElement(
    'div',
    { style: layoutCalcs.dayOfMonth['arc_view-days-of-month'], className: 'arc_view-days-of-month', role: 'grid' },
    daysOfMMonthViewMatrix.map(function (row, index) {
      return React.createElement(
        'div',
        { style: layoutCalcs.dayOfMonth.arc_view_row, className: 'arc_view_row', key: index },
        row.map(function (cell) {
          return React.createElement(
            'div',
            {
              ...
              className:
                'arc_view_cell' +
                (cell.activeMonthInView ? ' arc_active' : '') +
                (cell.isWeekend ? ' arc_wknd' : '') +
                (cell.isToday ? ' arc_today' : '') +
                (cell.isFirstRow ? ' arc_fr' : '') +
                (cell.isToday ? ' arc_today' : '') +
                (cell.isHighlight ? ' arc_highlight' : '') +
            ...
            React.createElement(
              'div',
              { style: layoutCalcs.dayOfMonth.arc_view_cell_value, className: 'arc_view_cell_value' },
              React.createElement(
                'button',
                {
...
var getStyles = function (size, fontSize) {
  return {
    root: {
      arc: {
        width: size + 'px',
...
function Calendar(_a) {
  var value = _a.value,
    isMultiSelector = _a.isMultiSelector,
    _b = _a.className,
    className = _b === void 0 ? '' : _b,
    isRangeSelector = _a.isRangeSelector,
    _c = _a.useDarkMode,
    useDarkMode = _c === void 0 ? false : _c,
    weekends = _a.weekends,
    _d = _a.highlights,
    highlights = _d === void 0 ? [] : _d,
    _e = _a.skipWeekendsInRange,
    skipWeekendsInRange = _e === void 0 ? false : _e,
    initialViewDate = _a.viewDate,
    _f = _a.allowFewerDatesThanRange,
    allowFewerDatesThanRange = _f === void 0 ? false : _f,
    _g = _a.startOfWeek,
    startOfWeek = _g === void 0 ? 1 : _g,
    maxAllowedDate = _a.maxAllowedDate,
    _h = _a.skipDisabledDatesInRange,
    skipDisabledDatesInRange = _h === void 0 ? false : _h,
    minAllowedDate = _a.minAllowedDate,
    fixedRange = _a.fixedRange,
    isDisabled = _a.isDisabled,
    onChange = _a.onChange,
    _j = _a.lockView,
    lockView = _j === void 0 ? false : _j,
    _k = _a.disableFuture,
    disableFuture = _k === void 0 ? false : _k,
    _l = _a.size,
    size = _l === void 0 ? 276 : _l,
    _m = _a.fontSize,
    fontSize = _m === void 0 ? 16 : _m,
    _o = _a.disablePast,
    disablePast = _o === void 0 ? false : _o,
    _p = _a.disableToday,
    disableToday = _p === void 0 ? false : _p;
  var styles = useMemo(
    function () {
      return getStyles(size, fontSize);
    },
    [size, fontSize],
  );
  ...
  var _q = useState(false),
    isRangeSelectModeOn = _q[0],
    setIsRangeSelectModeOn = _q[1];
  ...
  var weekendIndexes = useState(function () {
    return Array.isArray(weekends) &&
      (weekends.every(function (num) {
  ...
  var _s = useState(function () {
    ...
    selectedMultiDates = _s[0],
    setSelectedMultiDates = _s[1];
  ...
  var _t = useState(function () {
    ...
    selectedRangeStart = _t[0],
    setSelectedRangeStart = _t[1];
  var _u = useState(function () {
    ...
    selectedRangeEnd = _u[0],
    setSelectedRangeEnd = _u[1];
  var _v = useState(selectedRangeStart),
    newSelectedRangeStart = _v[0],
    setNewSelectedRangeStart = _v[1];
  var _w = useState(selectedRangeEnd),
    newSelectedRangeEnd = _w[0],
    setNewSelectedRangeEnd = _w[1];
  // View States
  var _x = useState('month_dates'),
    view = _x[0],
    setView = _x[1];
  var _y = useState(
  ...
  var changeMonthInView = useCallback(
    function (month) {
      !lockView && setMonthInView(month);
    },
    [lockView, setMonthInView],
  );
  var changeYearInView = useCallback(
    function (year) {
      !lockView && setYearInView(year);
    },
    [lockView, setYearInView],
  );
  var changeView = useCallback(
    function (view) {
      !lockView && setView(view);
    },
    [lockView, setView],
  );
  var _0 = useState(getStartOfRangeForAYear(yearInView)),
    startingYearForCurrRange = _0[0],
    setStartingYearForCurrRange = _0[1];
  useEffect(
    function () {
  ...
  var _1 = useMemo(
    ...
    yearMatrixRangeStart = _1[0],
    yearMatrixRangeEnd = _1[1];
  // callback handlers
  var onPrevClick = useCallback(
    function () {
      if (view === 'month_dates') {
        var isPrevMonthFromLastYear = monthInView === 0;
  ...
  var checkDisabledForADate = useMemo(
    function () {
  ...
  var checkIfWeekend = useMemo(
    function () {
      return checkIfWeekendHOF(weekendIndexes, startOfTheWeek);
    },
  ...
  return React.createElement(
    ...
    React.createElement(
      'div',
      { style: styles.root.arc_view, className: 'arc_view' },
      view === 'months' &&
      ...
      view === 'month_dates' &&
        React.createElement(
          React.Fragment,
          null,
          React.createElement(WeekDaysRow, {
            layoutCalcs: styles,
            weekStartIndex: startOfTheWeek,
            weekendIndices: weekendIndexes,
          }),
          React.createElement(DayOfMonthSelector, {
            isRangeSelectModeOn: isRangeSelectModeOn,
...
var giveFormatter = function (format) {
